...
当前版本为 `v0.1.0-beta.10` 发布候选：默认白底黑字，顶部 Dock 只保留“设置、预设块、Library、面板预览”四个入口；外部 AI、遥测和云同步均未启用。
...
- `v0.1.0-beta.10` 是明确的未签名、未公证测试包。稳定版 `v0.1.0` 在 Developer ID、Hardened Runtime、最小 entitlements、公证、staple 和安装态回归全部通过前禁止发布。
